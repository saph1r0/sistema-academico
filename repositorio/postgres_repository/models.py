...
class AcademicPeriod(models.Model):
    ...
    laboratory_enrollment_start = models.DateField(default=timezone.now)
    laboratory_enrollment_end = models.DateField(default=timezone.now)
    enrollment_change_deadline = models.DateField(default=timezone.now)
...
class Horario(models.Model):
    ...
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    course_group = models.ForeignKey(CourseGroup, on_delete=models.CASCADE, related_name='horarios')
    aula = models.ForeignKey(Aula, on_delete=models.SET_NULL, null=True, blank=True, related_name='horarios')
