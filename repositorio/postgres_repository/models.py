...
class AcademicPeriod(models.Model):
    ...
    laboratory_enrollment_start = models.DateField(null=True, blank=True) 
    laboratory_enrollment_end = models.DateField(null=True, blank=True)   
    enrollment_change_deadline = models.DateField(null=True, blank=True)  
