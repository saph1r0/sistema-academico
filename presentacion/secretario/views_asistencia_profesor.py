...
class SecretarioAsistenciaProfesorView(View):
    # RUTA CAMBIADA A LA CARPETA DE SECRETARIO
    template_name = "secretario/asistencia_profesor.html"
    ...
    def get(self, request):
        ...
        if teacher_id and course_id:
            ...
            # Importamos los helpers que ya existen en el modulo del profesor
